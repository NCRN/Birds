...
Begin Form
    ...
    OrderBy ="tsys_Link_Tables.Link_table"
    RecSrcDt = Begin
        0xb70bcdfd760be340
    End
...
' =================================
' Description:  Linked table subform
' Data source:  tsys_Link_Tables
' Data access:  delete
' Pages:        none
' Functions:    none
' References:   none
...
'if a user tries to delete a table that is linked in the form, the link is removed from the database and the record of the link is
'   removed from the tsys_Link_Tables table
Dim strSQL As String

On Error GoTo Err_Handler

If MsgBox("This action will delete the table link for " & Me!Link_table & " from the database! Are you sure you wish to continue?", vbYesNo + vbExclamation, "Delete Table Link?") = vbYes Then
