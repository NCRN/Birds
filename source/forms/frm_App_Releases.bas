            ...
            Begin
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT tlu_Enumerations.Enum_Code, tlu_Enumerations.Enum_Description, tlu_Enumer"
                        "ations.Enum_Group FROM tlu_Enumerations WHERE (((tlu_Enumerations.Enum_Code)=\"N"
                        "CRN\")); "
                ...
                Begin TextBox
                    ...
                    TabIndex =12
                    ForeColor =16711680
                    Name ="txtDBDocumentation"
                    ControlSource ="SOPVer"
                    ...
                    HyperlinkTarget ="https://irma.nps.gov/App/Reference/Profile?code=2222170"
                    Begin
                        Begin Label
                            OverlapFlags =85
                            Left =60
                            ...
                            FontWeight =700
                            Name ="Label22"
                            Caption ="Database Documentation SOP:"
                            FontName ="Arial"
                            LayoutCachedLeft =60
                            LayoutCachedTop =2280
