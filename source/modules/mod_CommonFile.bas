...
' Revisions:    John R. Boetsch, 5/17/2006 - documentation
'               JRB, 6/22/2009 - updated adhAddFilterItem
'               Stephen G. Gentry, 9/16/2014 - conditional declarations for 64-bit resiliency

Option Compare Database
Option Explicit
' Conditional compilation use PtrSafe when 64 bit
#If Win64 Then
...
' Source/date:  From Access97 Developer's Handbook by Litwin, Getz and Gilbert (Sybex)
'               Copyright 1997.  All Rights Reserved
' Revisions:    John R. Boetsch, 5/17/2006 - fixed strInitialDir under With block,
'               added error-traps
' =================================
    ...
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - adhCommonFileOpenSave)"
    End Select
...
' Source/date:  From Access97 Developer's Handbook by Litwin, Getz and Gilbert (Sybex)
'               Copyright 1997.  All Rights Reserved
' Revisions:    John R. Boetsch, 5/17/2006 - documentation and error-trapping
'               JRB, 6/22/2009 - added default description in case the file type wasn't passed
' =================================
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - adhAddFilterItem)"
    End Select
    Resume Exit_Procedure
...
Err_Handler:
    Select Case Err.Number
      Case Else
        MsgBox "Error #" & Err.Number & ": " & Err.Description, vbCritical, _
            "Error encountered (#" & Err.Number & " - adhTrimNull)"
    End Select
    Resume Exit_Procedure
