Operation =1
Option =0
Having ="(((tbl_Locations.Unit_Code)=\"wotr\") AND ((tbl_Field_Data.TSN) Is Not Null))"
Begin InputTables
    Name ="tlu_Species"
    Name ="tbl_Locations"
    Name ="tbl_Events"
...
Begin OutputColumns
    ...
    Alias ="Observer"
    Expression ="Last([First_Name] & \" \" & [Last_Name])"
    Alias ="LocalLocCode"
    ...
    Expression ="1"
    Alias ="ObservationMethodDetails"
    Expression ="[ID_Text] & \" used to identify birds during 10 min. pt. cnt.\""
    Alias ="DataSource"
    Expression ="\"NCRN Forest Bird Monitoroing\""
    Alias ="EnteredBy"
    Expression ="\"Geoff Sanders\""
    Alias ="Sex"
    Expression ="IIf([Sex_ID]<>2 Or [Sex_ID]<>3,5,[Sex_ID])"
    Alias ="ObservationMethod"
    Expression ="IIf([ID_Method_Code]=\"C\" Or [ID_Method_Code]=\"S\",2,IIf([ID_Method_Code]=\"V\""
        ",4,\"\"))"
    Alias ="EnteredDate"
    Expression ="Now()"
