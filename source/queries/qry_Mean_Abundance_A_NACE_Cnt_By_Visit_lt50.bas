...
Having ="(((tbl_Locations.Admin_Unit_Code)=\"NACE\") AND ((tbl_Field_Data.AOU_Code)<>\"BC"
    "CH\" And (tbl_Field_Data.AOU_Code)<>\"CACH\" And (tbl_Field_Data.AOU_Code)<>\"CH"
    "DE\" And (tbl_Field_Data.AOU_Code)<>\"CACH\" And (tbl_Field_Data.AOU_Code)<>\"UN"
    "WA\" And (tbl_Field_Data.AOU_Code)<>\"UNCR\" And (tbl_Field_Data.AOU_Code)<>\"UN"
    "HA\" And (tbl_Field_Data.AOU_Code)<>\"UNWO\" And (tbl_Field_Data.AOU_Code)<>\"UN"
    "DU\" And (tbl_Field_Data.AOU_Code)<>\"UNFL\" And (tbl_Field_Data.AOU_Code)<>\"UN"
    "GU\" And (tbl_Field_Data.AOU_Code)<>\"UNHU\" And (tbl_Field_Data.AOU_Code)<>\"UN"
    "OW\" And (tbl_Field_Data.AOU_Code)<>\"UNSA\" And (tbl_Field_Data.AOU_Code)<>\"UN"
    "SP\" And (tbl_Field_Data.AOU_Code)<>\"UNSW\" And (tbl_Field_Data.AOU_Code)<>\"UN"
    "TE\" And (tbl_Field_Data.AOU_Code)<>\"UNWR\") AND ((tbl_Field_Data.Distance_id)="
    "1) AND ((tbl_Field_Data.Previously_Obs)=False))"
Begin InputTables
    Name ="tlu_Species"
    Name ="tbl_Locations"
    Name ="tbl_Events"
