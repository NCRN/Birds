Operation =1
Option =2
Where ="(((tlu_Guild_Assignment.Guild_Assignment_Code) Is Not Null) AND ((tlu_Guild_Assi"
    "gnment.Guild_Level)=\"Native\" Or (tlu_Guild_Assignment.Guild_Level)=\"Exotic\")"
    ")"
Begin InputTables
    Name ="tlu_Species"
    Name ="tbl_Field_Data"
...
Begin
    ...
    End
    Begin
        dbText "Name" ="Exotic Description"
        dbLong "AggregateType" ="-1"
    End
End
Begin
