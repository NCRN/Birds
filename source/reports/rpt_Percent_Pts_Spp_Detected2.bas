...
Begin Report
    ...
    RecSrcDt = Begin
        0x3b55833e2e5de440
    End
    RecordSource ="qxtab_Percent_Plots_Where_Species_Detected"
        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =2
                    Name ="Text37"
                    ControlSource ="=\"Proportion of Points Where Species Were Detected at \" & [Park]"
...
Private Sub Report_Open(Cancel As Integer)
   ...
   Set qdf = dbsReport.QueryDefs("qxtab_Percent_Plots_Where_Species_Detected")
